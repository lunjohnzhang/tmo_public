...
#SBATCH --partition=little-pokemon
...
# Kill the scheduler, as the scheduler will keep running on little Pokemon for
# some reason.
kill \$(pgrep -f dask-scheduler)
