...
class WarehouseNCA(nn.Module):
    ...
    def generate(self, seed_envs, n_iter, save=False):
        """Generate warehouse env with the model using seed_env for n_iters

        Args:
            seed_envs (n, env_height, env_width): tensor of int envs
            n_iter (int): number of iterations
            save (bool): whether to save itermediate steps
        """

        batch_size, env_height, env_width = seed_envs.shape
