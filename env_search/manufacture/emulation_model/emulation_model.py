"""Provides primary ManufactureEmulationModel."""
import logging
...
from env_search.manufacture.emulation_model.aug_buffer import AugBuffer
from env_search.manufacture.emulation_model.double_aug_buffer import DoubleAugBuffer
from env_search.manufacture.emulation_model.buffer import Buffer, Experience
from env_search.manufacture.emulation_model.networks import (
    ManufactureConvolutional, ManufactureAugResnetOccupancy,
...
NETWORKS = (ManufactureConvolutional, )


@gin.configurable(denylist=["seed"])
class ManufactureEmulationModel:
    """Class for manufacture emulation model.
    ...
    Usage:
        model = ManufactureEmulationModel(...)
    ...
    def __init__(
        ...
        if pre_network_type is None:
            ...
            self.pre_network = pre_network_type().load_from_saved_weights().to(
                DEVICE)
            if isinstance(self.pre_network, ManufactureAugResnetOccupancy):
    ...
    def train(self, end_to_end=False):
                ...
                for sample in dataloader:
                    ...
                    if self.pre_network is not None:
                        if isinstance(self.pre_network,
                            ...
                            _, env_height, env_width = repaired_map.shape
        ...
        # Train each part of the model separately
            ...
            if self.pre_network is not None:
                ...
                elif isinstance(self.pre_network, ManufactureAugResnetOccupancy):
                    freeze_params(self.network)
    ...
    def save(self, pickle_path: Path, pytorch_path: Path):
        ...
        """
        logger.info("Saving ManufactureEmulationModel pickle data")
        ...
        logger.info("Saving ManufactureEmulationModel PyTorch data")
        state_dict = {
