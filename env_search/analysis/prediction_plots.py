...
def main(logdir_json):
    ...
    for domain in domain_list:
        ...
        for alg in alg_list:
            ...
            for i in range(0, len(envs), batch_size := 1000):
                pred_obj, pred_measure = em.predict(envs[i:i + batch_size])
